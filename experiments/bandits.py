...
import argparse
import numpy as np
from src.utils import MAB as MAB
from src.utils import plots as plots
from src.utils import io_mgmt as io_mgmt
from src.algorithms import thompson as thompson
from src.algorithms import ucb as UCB
from src.algorithms import causal_thompson as causal_thompson
...
def main():
    ...
    bandit = MAB.create_bandit(args.bandit_type, *args)
